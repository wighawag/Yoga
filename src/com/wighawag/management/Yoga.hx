...
import com.wighawag.management.command.SetupCommand;
...
class Yoga extends CommandLineRunner {
	...
	public function new()
	{
		...
		mapCommand(SetupCommand, "setup", ["s"], "setup yoga so that it can be call with 'yoga' instead of 'haxelib run yoga' the project");
